...
LOGIN_REDIRECT_URL = reverse_lazy('zona_privada')
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'encuestafinanciera@correo.unicordoba.edu.co'
EMAIL_HOST_PASSWORD = 'Financiera*2018*'
EMAIL_USE_TLS = True